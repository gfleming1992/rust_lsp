// Batch shader for rendering multiple different geometries with different colors/transforms
// in a single draw call using a storage buffer.
// Renamed from: polyline_batch.wgsl
